...
router.patch("/:customerId/password", auth_middleware_1.authenticateCustomer, (0, middleware_Validation_1.validation)(validators.updatePasswordSchema), Customer_Controller_1.default.updatePassword);
